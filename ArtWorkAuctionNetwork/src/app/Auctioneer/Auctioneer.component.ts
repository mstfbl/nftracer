...
export class AuctioneerComponent implements OnInit {
  ...
  constructor(public serviceAuctioneer: AuctioneerService, fb: FormBuilder) {
  ...
  addParticipant(form: any): Promise<any> {
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceAuctioneer.updateParticipant(form.get('userId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
